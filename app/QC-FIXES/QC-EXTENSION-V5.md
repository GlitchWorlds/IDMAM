...
### E7: Save button  no indication settings apply to NEW downloads only 
File: options.html
...
### E8: `downloads.shelf` permission side effect 
File: manifest.json
...
### E9: No "Save Path" display in popup 
File: popup.js
...
### E10: Settings not synced between popup and options 
