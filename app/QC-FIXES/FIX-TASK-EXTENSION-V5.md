...
5. Show current IDMM default path as placeholder text

## E5: WebSocket real-time sync
Files: D:\IDMM\extension\background.js, D:\IDMM\extension\popup\popup.js
Fix:
...
Files: D:\IDMM\extension\manifest.json
Fix: Remove "downloads.shelf" from permissions array (not used in any code)

## E9: Show save path in popup
Files: D:\IDMM\extension\popup\popup.js, D:\IDMM\extension\popup\popup.css
Fix:
