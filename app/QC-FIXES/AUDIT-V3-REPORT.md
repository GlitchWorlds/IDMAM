...
| 3.14 | Error message leakage | **WARNING** | `err.message` returned directly in 500 responses. Could leak internal paths (e.g., `ENOENT: /home/user/.IDMM/...`). Low risk for localhost-only API. |
