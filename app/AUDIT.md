...
| T34 | `main()` | **Exponential backoff**: Verify delays: attempt 12: 1s, attempt 23: 2s |
...
| T120 | `parseContentDisposition()` | **RFC 5987**: `filename*=UTF-8''%E4%B8%AD%E6%96%87.zip`  verify returns ".zip" |
